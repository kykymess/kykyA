...
class Terrain:
    ...
    def __init__(self, lig:int=1, col:int=10, borne:bool=True,
        ...
        if isinstance(col, bool): self.__nc = 10
        else:
    ...
    @property
    def lignes(self): return self.__nl
    @property
    def colonnes(self): return self.__nc
    @property
    def fini(self): return self.__bound
    @property
    def obstacles(self): return self.__obs
    @property
    def firmes(self): return self.__nf
    @property
    def dmin(self): return self.__dmin
    @property
    def voisinage(self): return self.__vicinity

    #==================== lecture écriture =============================#
    def get_firmePM(self): return self.__fPM
    @intRequired
    def set_firmePM(self, v):
        """ un entier entre 1 et lig*col """
        if 1 <= v <= self.__area: self.__fPM = v
    firmePM = property(get_firmePM, set_firmePM)
    def get_prixMinimum(self): return self.__pmini
    @intRequired
    def set_prixMinimum(self, v):
        """ un entier entre 1 et prixMaxi """
        if 1 <= v <= self.prixMaximum: self.__pmini = v
    prixMinimum = property(get_prixMinimum, set_prixMinimum)
    def get_prixMaximum(self): return self.__pmaxi
    @intRequired
    ...
    def get_clientCost(self): return self.__cLambda
    ...
    def get_clientUtility(self): return self.__cUtil
    @intRequired
    ...
    def __sansObs(self, c1:tuple, c2:tuple) -> int:
        ...
        a,b = c2
        if self.fini:
            if self.voisinage: return abs(x-a)+abs(y-b)
            else: return max(abs(x-a), abs(y-b))
    ...
    def step(self, flag:bool) -> None:
        ...
        else: self.__Trace.store(_struct)
    ...
    def simulation(self, nbTour:int=None, ordre:bool=None,
        ...
        if ordre is None:
            ...
            if len(_r)==0 or _r[0] in _yes_: ordre = False
            else: ordre = True
